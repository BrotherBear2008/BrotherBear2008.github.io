...
<title>Haker：思州网络后台管理 QQ:8210856</title>
  ...
  <table width="100%" height="26"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#B6E6FB">
    <tr>
      <td height="25" colspan="2" background="images/bg1.png"><table width="100%" border="0">
        <tr>
          <td><div align="left"><span class="STYLE3"><strong>&nbsp;思州网络后台管理中心</strong></span></div></td>
    ...
    <tr>
      <td bgcolor="white"><p><span class="STYLE3">　</span><span class="STYLE4"><a href="data.asp" target="main">查看数据</a></span><span class="STYLE3"><span class="STYLE4"> 　| 　<a href="password.asp" target="main">修改密码</a> 　| 　<a href="http://985.so/" target="main">缩短地址</a> 　| 　</span></span><span class="STYLE4"><a href="about.asp" target="main">关于程序</a></span><span class="STYLE3"><span class="STYLE4"> 　|  　</span></span><span class="STYLE4 STYLE5"><a href="Exit.asp" target="_parent" ONCLICK="javascript:return confirm('提示：您确定要退出吗？')">安全退出</a></span></p>      </td>
    </tr>
    <tr>
      <td bgcolor="white"><div align="center"><span class="STYLE3">注意：该程序请勿非法使用,仅供学习! 子晨 QQ:8210856 </span> </div></td>
    </tr>
  </table>
</div>
</body>
